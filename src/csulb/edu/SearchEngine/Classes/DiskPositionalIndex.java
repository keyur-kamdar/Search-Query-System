 ...
 * @throws IOException 
   */
   private static long[] Variable_readVocabTable(String indexName) {
	   try {
		   long[] vocabTable;
		   RandomAccessFile tableFile = new RandomAccessFile( new File(indexName, "Variable_vocabTable.bin"), "r");
   ...
   private static long[] Impact_readVocabTable(String indexName) {
	   try {
		   long[] vocabTable; 
		   RandomAccessFile tableFile = new RandomAccessFile( new File(indexName, "Impact_vocabTable.bin"), "r");
